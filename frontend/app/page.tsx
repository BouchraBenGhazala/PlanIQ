...
//     {
//       role: "assistant",
//       content: "Hello! I am PlanIQ. I can manage your Google Calendar. Ask me to check your schedule or book a meeting!",
//     },
//   ]);
...
//     // 1. Construct the new history locally
//     // We add the new user message to the existing history
...
//       // This allows the AI to have "Memory"
...
//       setMessages((prev) => [
//         ...prev,
//         { role: "assistant", content: "Error: Could not connect to PlanIQ Brain. Is the backend running on port 8080?" },
//       ]);
//     } finally {
//       setIsLoading(false);
//     }
...
//       {/* HEADER */}
//       <header className="flex items-center gap-3 border-b border-slate-800 bg-slate-900/50 p-4 backdrop-blur-md sticky top-0 z-10">
...
//             {/* Message Bubble */}
//             <div
//               className={`relative max-w-[85%] rounded-2xl px-5 py-3 shadow-md ${
//                 msg.role === "user"
...
//             {/* User Avatar */}
//             {msg.role === "user" && (
//               <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-700 mt-1">
...
//               <span className="text-sm text-slate-400">PlanIQ is thinking...</span>
//             </div>
//           </div>
//         )}
...
//           <div className="relative flex items-center gap-2 rounded-xl bg-slate-800 p-2 border border-slate-700 focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500 transition-all">
//             <input
//               type="text"
...
//               className="rounded-lg bg-indigo-600 p-2 text-white transition hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
//             >
//               <Send className="h-5 w-5" />
//             </button>
//           </div>
//           <p className="mt-3 text-center text-xs text-slate-500">
//             Powered by <b>LangGraph</b> & <b>Google Calendar API</b>
//           </p>
//         </div>
//       </footer>
//     </div>
